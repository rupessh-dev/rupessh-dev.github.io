    ...
    return (
        <div className="bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-2xl p-4 md:p-6 lg:p-8">
            <h2 className="text-xl md:text-2xl font-semibold text-white mb-4 md:mb-6 flex items-center">
                <svg className="w-5 h-5 md:w-6 md:h-6 mr-2 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 md:gap-4 mb-6 md:mb-8">
                <div className="text-center">
                    <div className="text-xl md:text-2xl font-bold text-purple-400">{results.weeksCompleted}</div>
                    <div className="text-xs md:text-sm text-gray-400">Weeks Done</div>
                </div>
                <div className="text-center">
                    <div className="text-xl md:text-2xl font-bold text-blue-400">{Math.max(0, 40 - results.weeksCompleted)}</div>
                    <div className="text-xs md:text-sm text-gray-400">Weeks Left</div>
                </div>
                <div className="text-center">
                    <div className="text-xl md:text-2xl font-bold text-pink-400">{Math.round(progressPercentage)}%</div>
                    <div className="text-xs md:text-sm text-gray-400">Complete</div>
                </div>
                <div className="text-center">
                    <div className="text-xl md:text-2xl font-bold text-cyan-400">{results.daysLeft}</div>
                    <div className="text-xs md:text-sm text-gray-400">Days Left</div>
                </div>
            </div>
            ...
            <div className="space-y-3 md:space-y-4">
                <div className="flex justify-between items-center">
                    <span className="text-gray-300 font-medium text-sm md:text-base">Overall Progress</span>
                    <span className="text-white font-bold text-sm md:text-base">{Math.round(progressPercentage)}%</span>
                </div>
                
                <div className="relative h-4 md:h-6 bg-gray-800 rounded-full overflow-hidden">
                    {/* Progress fill */}
                    <div 
            ...
            <div className="mt-6 md:mt-8 space-y-4 md:space-y-6">
                <h3 className="text-base md:text-lg font-semibold text-white">Trimester Progress</h3>
                
                {/* First Trimester */}
                <div className="space-y-2">
                    <div className="flex justify-between items-center">
                        <span className="text-gray-300 text-sm md:text-base">First Trimester (Weeks 1-12)</span>
                ...
                <div className="space-y-2">
                    <div className="flex justify-between items-center">
                        <span className="text-gray-300 text-sm md:text-base">Second Trimester (Weeks 13-27)</span>
                ...
                <div className="space-y-2">
                    <div className="flex justify-between items-center">
                        <span className="text-gray-300 text-sm md:text-base">Third Trimester (Weeks 28-40)</span>
                        <span className="text-pink-400 font-medium text-sm md:text-base">
            ...
            <div className="mt-6 md:mt-8 p-3 md:p-4 bg-gradient-to-r from-purple-500/10 via-blue-500/10 to-pink-500/10 rounded-xl border border-purple-500/20">
                <div className="flex items-start md:items-center">
                    <svg className="w-5 h-5 md:w-6 md:h-6 text-yellow-400 mr-3 mt-0.5 md:mt-0 flex-shrink-0" fill="currentColor" viewBox="0 0 24 24">
